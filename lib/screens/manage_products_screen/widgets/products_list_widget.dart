    ...
    return Consumer<ManageProductsScreenProvider>(
      builder: (context, _provider, child) {
        return ListView.separated(
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        _provider.productsList[index].productName!,
                      ...
                      Text(
                        _provider.productsList[index].productDescription!,
                        style: const TextStyle(fontSize: 14.0),
                      ),
                      const SizedBox(height: 3),
                      Text(
                        _provider.productsList[index].productPrice! + " K.D",
                        style: const TextStyle(
          ...
          itemCount: _provider.productsList.length,
        );
      },
    );
  }
